var Fluxxor = require("fluxxor"),
    ...
    AssetsStore = Fluxxor.createStore({
        initialize: function() {
            this.assets = [], this.assetsLoaded = !1, this.loading = !1, this.bindActions(constants.LOAD_ASSETS_SUCCESS, this.onLoadAssetsSuccess, constants.LOAD_ASSETS, this.onLoadAssets)
        },
