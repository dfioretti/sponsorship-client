          ...
          <Col md={4}>
            <Card style={{margin: "25px", width: "100%"}}>
              <Row style={{padding: "20px"}}>
                <Col md={4}>
                <Avatar
                  src={this.state.asset.image_url}
                  size={150}
                  />
                </Col>
                <Col style={{marginTop: "20px"}} md={8}>
                  <CardTitle style={{textTransform: "uppercase"}} title={this.state.asset.name}>
                  <Label bsStyle="primary">{this.state.asset.scope}</Label>&nbsp;
                  <Label bsStyle="success">{this.state.asset.category}</Label>&nbsp;
                  <Label bsStyle="info">{this.state.asset.subcategory}</Label>
                  </CardTitle>
                </Col>
              </Row>
              <Row>
